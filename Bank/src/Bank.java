...
public class Bank {
    ...
    public void input(Scanner scan) {
    	...
    	System.out.print("Enter money to diposit ="); money = scan.nextFloat();
    	System.out.print("Enter money to widthdraw ="); wid = scan.nextFloat();  
    }
    public void output() {
    	String st = "";
        st = st + id +"\t"+name+"\t\t"+amount+"$"+"\t\t"+money+"$"+"\t\t"+Deposit(money)+"$"+"\t\t"+wid+"$"+"\t\t"+Widthdraw(wid)+"$";
